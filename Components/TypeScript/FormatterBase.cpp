#include "Components/TypeScript/FormatterBase.hpp"
    ...
    : Formatter(FormatterConfig
        {
            ...
            PrimitiveConfigs {
                ...
                PrimitiveConfig<Primitive::Underlying::OBJECTID>("ObjectId"),
                PrimitiveConfig<Primitive::Underlying::VERSIONID>("VersionId"),
                PrimitiveConfig<Primitive::Underlying::TYPEID>("TypeId"),
