...
void RpcBinaryFormatter::_footer(std::ostream& stream, Model::RootRef root) const
{
    ...
    stream << "class " << "Everbase_Internal_Library_SharedMemoryClient_ProxyObjectDestroyed" << " : public OperationWrapper" << endl
           << "{" << endl;
    ...
    stream << "// destructor for operation to for destroyed client proxy objects }" << endl << endl << endl;
    ...
    stream << "std::pair<std::string, std::shared_ptr<everbase::internal::common::rpc::binary::OperationWrapper>>{\"Everbase::Internal::Library::SharedMemoryClient::ProxyObjectDestroyed\", std::shared_ptr<everbase::internal::common::rpc::binary::OperationWrapper>(new "
                   << "everbase::internal::common::rpc::binary::Everbase_Internal_Library_SharedMemoryClient_ProxyObjectDestroyed())}," << endl
           << "};" << endl;
